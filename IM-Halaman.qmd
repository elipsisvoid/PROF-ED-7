...
The Pythagorean theorem states that the sum of the squares of the measures of the legs *a* and *b* of $\triangle ABC$ is equal to the square of the measure of the hypotenuse *c* that is *a*$^{2}$ + *b*$^{2}$ = *c*$^{2}$. By laying the given right triangle $\triangle ABC$ in a unit circle as shown below, the formula *a*$^{2}$ + *b*$^{2}$ = *c*$^{2}$ becomes *a*$^{2}$ + *b*$^{2}$ = 1. Recall that the radius of a unit circle is equal to 1 unit, which in the triangle shown in the figure above, corresponds to the hypotenuse *c*.
...
![](IM-Halaman_files/images/Example%203%20Image.png){fig-align="center"}
